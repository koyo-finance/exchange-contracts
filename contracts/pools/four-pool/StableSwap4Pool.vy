# @version 0.3.1
# (c) Curve.Fi, 2020
# Modified by Kōyō Finance, 2022
# Pool for FRAX/DAI/USDC/USDT on Boba
...
PRECISION_MUL: constant(uint256[N_COINS]) = [1, 1, 1000000000000, 1000000000000]
RATES: constant(uint256[N_COINS]) = [1000000000000000000, 1000000000000000000, 1000000000000000000000000000000, 1000000000000000000000000000000]
...
KILL_DEADLINE_DT: constant(uint256) = 7 * 4 * 6 * 86400
...
@external
def kill_me(): # I can relate to this...
    assert msg.sender == self.owner  # dev: only owner
